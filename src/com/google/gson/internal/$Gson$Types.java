...
public final class $Gson$Types {
			...
			while (rawType != Object.class) {
				...
				if (rawSupertype == toResolve) {
					return rawType.getGenericSuperclass();
						...
						.isAssignableFrom(rawSupertype)) { return getGenericSupertype(rawType.getGenericSuperclass(),
	...
	public static Type[] getMapKeyAndValueTypes(Type context, Class<?> contextRawType) {
		 ...
		 */
		if (context == Properties.class) { return new Type[] { String.class, String.class }; // TODO: test subclasses of Properties!
		}
	...
	private static final class ParameterizedTypeImpl implements ParameterizedType, Serializable {
		...
		public String toString() {
			...
			if (this.typeArguments.length == 0) { return stringBuilder.toString(); }
