...
public class OpenItemer extends PluginData {
	...
	public static void inits() {
		ItemMeta ids = OpenItemer.item.getItemMeta();
		ids.setDisplayName(Utils._ReplaceColour(SetFiles.getConfig().getString("Open_BookName")));
		...
		ids.setLore(lore);
		OpenItemer.item.setItemMeta(ids);
	}

	public static void givebook(Player player) {
		player.getInventory().addItem(OpenItemer.item);
	}
